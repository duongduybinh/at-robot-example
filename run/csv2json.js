...
var require_Parameters = __commonJS({
  "node_modules/csvtojson/v2/Parameters.js"(exports2) {
    "use strict";
    ...
    exports2.mergeParams = mergeParams;
  }
});

// node_modules/csvtojson/v2/ParseRuntime.js
var require_ParseRuntime = __commonJS({
  "node_modules/csvtojson/v2/ParseRuntime.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    ...
    exports2.initParseRuntime = initParseRuntime;
  }
});
...
var require_Processor = __commonJS({
  "node_modules/csvtojson/v2/Processor.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    var Processor = (
      /** @class */
...
var require_dataClean = __commonJS({
  "node_modules/csvtojson/v2/dataClean.js"(exports2) {
    "use strict";
    ...
    exports2.prepareData = prepareData;
...
var require_getEol = __commonJS({
  "node_modules/csvtojson/v2/getEol.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
...
var require_fileline = __commonJS({
  "node_modules/csvtojson/v2/fileline.js"(exports2) {
    "use strict";
    var __importDefault = exports2 && exports2.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    exports2.stringToLines = stringToLines;
  }
});

// node_modules/csvtojson/v2/util.js
var require_util2 = __commonJS({
  "node_modules/csvtojson/v2/util.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    ...
    exports2.emptyBuffer = emptyBuffer;
    ...
    exports2.trimLeft = String.prototype.trimLeft ? function trimLeftNative(str) {
      return str.trimLeft();
    } : function trimLeftRegExp(str) {
      return str.replace(/^\s+/, "");
    };
    exports2.trimRight = String.prototype.trimRight ? function trimRightNative(str) {
...
var require_rowSplit = __commonJS({
  "node_modules/csvtojson/v2/rowSplit.js"(exports2) {
    "use strict";
    var __importDefault = exports2 && exports2.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    var RowSplit = (
      ...
      (function() {
        function RowSplit2(conv) {
          ...
          this._needEmitDelimiter = void 0;
        ...
        Object.defineProperty(RowSplit2.prototype, "needEmitDelimiter", {
          get: function() {
            if (this._needEmitDelimiter === void 0) {
        ...
        RowSplit2.prototype.toCSVRow = function(rowArr, trim, quote, delimiter) {
          var row = [];
          var inquote = false;
          var quoteBuff = "";
        ...
        RowSplit2.prototype.escapeQuote = function(segment) {
          ...
          if (this.cachedRegExp[key] === void 0) {
    ...
    exports2.RowSplit = RowSplit;
  }
});

// node_modules/csvtojson/v2/CSVError.js
var require_CSVError = __commonJS({
  "node_modules/csvtojson/v2/CSVError.js"(exports2) {
    "use strict";
    ...
    var CSVError = (
      ...
      (function(_super) {
        ...
        CSVError2.fromJSON = function(obj2) {
          return new CSVError2(obj2.err, obj2.line, obj2.extra);
        };
...
var require_lineToJson = __commonJS({
  "node_modules/csvtojson/v2/lineToJson.js"(exports2) {
    "use strict";
    var __importDefault = exports2 && exports2.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    function getConvFunc(head, i, conv) {
      if (conv.parseRuntime.columnConv[i] !== void 0) {
...
var require_ProcessorLocal = __commonJS({
  "node_modules/csvtojson/v2/ProcessorLocal.js"(exports2) {
    "use strict";
    var __extends = exports2 && exports2.__extends || (function() {
      var extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d, b) {
        d.__proto__ = b;
    ...
    var ProcessorLocal = (
      ...
      (function(_super) {
        ...
        function ProcessorLocal2() {
          ...
          _this._needEmitEol = void 0;
          _this.headEmitted = false;
          _this._needEmitHead = void 0;
          return _this;
        }
        ProcessorLocal2.prototype.flush = function() {
          ...
          if (this.runtime.csvLineBuffer && this.runtime.csvLineBuffer.length > 0) {
            ...
            this.runtime.csvLineBuffer = void 0;
    ...
    exports2.ProcessorLocal = ProcessorLocal;
...
var require_Result = __commonJS({
  "node_modules/csvtojson/v2/Result.js"(exports2) {
    "use strict";
    var __importDefault = exports2 && exports2.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    var Result = (
      ...
      (function() {
        ...
        Object.defineProperty(Result2.prototype, "needPushDownstream", {
          get: function() {
            if (this._needPushDownstream === void 0) {
...
var require_Converter = __commonJS({
  "node_modules/csvtojson/v2/Converter.js"(exports2) {
    "use strict";
    var __extends = exports2 && exports2.__extends || (function() {
      var extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d, b) {
        d.__proto__ = b;
    ...
    var Converter = (
      ...
      (function(_super) {
        ...
        Converter2.prototype.fromFile = function(filePath, options) {
          var _this = this;
          var fs2 = require("fs");
          fs2.exists(filePath, function(exist) {
            if (exist) {
              var rs = fs2.createReadStream(filePath, options);
              rs.pipe(_this);
            } else {
        ...
        Converter2.prototype._flush = function(cb) {
          var _this = this;
          this.processor.flush().then(function(data) {
            if (data.length > 0) {
...
var require_v2 = __commonJS({
  "node_modules/csvtojson/v2/index.js"(exports2, module2) {
    "use strict";
    ...
    const jsonArray = await csvtojson({
      colParser: {
        confirmInforConsultation: (item) => {
          if (!item) return [];
          return item.split(";").map((x) => x.trim()).filter((x) => x.length > 0);
        }
      }
    }).fromString(csv);
